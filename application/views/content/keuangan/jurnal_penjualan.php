                ...
                <div class="container-fluid">
                    <div class="page-title-row">
                        <div class="page-title-left">
                            ...
                            <h1 class="page-title">Jurnal Penjualan</h1>
                        </div>
                    </div>
                    ...
                    <div class="list-panel">
                        ...
                        <div class="list-toolbar">
                            ...
                            <input type="text" class="form-control sales-journal-search" id="salesJournalSearch" placeholder="Cari referensi, SO, pelanggan...">
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover table-striped zahir-table">
                                ...
                                <tbody id="salesJournalRows">
                                    <tr><td colspan="6" class="text-center text-muted py-4">Memuat jurnal penjualan...</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderRows(rows) {
        ...
        if (!rows || !rows.length) {
            $('#salesJournalRows').html('<tr><td colspan="6" class="text-center text-muted py-4">Data jurnal penjualan tidak ditemukan.</td></tr>');
            return;
        }
