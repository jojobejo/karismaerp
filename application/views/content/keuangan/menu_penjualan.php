            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="report-card-grid">
                        <a href="<?= base_url('jurnal/penjualan') ?>" class="report-card-link">
                            <span class="support-card-btn">
                                <span class="support-card-icon"><i class="fas fa-file-invoice-dollar"></i></span>
                                <span class="support-card-title">Daftar Jurnal Penjualan</span>
                                <span class="support-card-desc">Daftar pencatatan jurnal transaksi penjualan (Faktur Penjualan).</span>
                            </span>
                        </a>
                        <a href="<?= base_url('jurnal/pembayaran') ?>" class="report-card-link">
                            <span class="support-card-btn">
                                <span class="support-card-icon"><i class="fas fa-money-check-alt"></i></span>
                                <span class="support-card-title">Daftar Jurnal Pembayaran</span>
                                <span class="support-card-desc">Daftar pencatatan jurnal penerimaan kas/bank (Pembayaran Faktur).</span>
                            </span>
                        </a>
                        <a href="<?= base_url('jurnal/retur-penjualan') ?>" class="report-card-link">
                            <span class="support-card-btn">
                                <span class="support-card-icon"><i class="fas fa-undo-alt"></i></span>
                                <span class="support-card-title">Retur Penjualan</span>
                                <span class="support-card-desc">Daftar pencatatan jurnal transaksi retur barang dari pelanggan (Retur Penjualan).</span>
                            </span>
                        </a>
                    </div>
                </div>
