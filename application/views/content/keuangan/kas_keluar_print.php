<!-- application/views/content/keuangan/kas_keluar_print.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <title>KAS KELUAR — <?= htmlspecialchars($header['no_referensi']) ?></title>
    <style>
        body {
...
<body onload="window.print();">
    ...
    <div class="header-print">
        ...
        <div style="font-size: 12px;">BUKTI PENGELUARAN KAS / BANK (KAS KELUAR)</div>
    </div>
    ...
    <table class="meta-table">
        ...
        <tr>
            <td>Penerima</td>
            <td>:</td>
            <td colspan="4"><strong><?= htmlspecialchars($header['penerima']) ?></strong></td>
        </tr>
        <tr>
            <td>Memo / Catatan</td>
            <td>:</td>
