                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-2">
                                        <form action="<?= base_url('ics/sync_po_pre_do') ?>" method="post" onsubmit="return confirm('Tarik data PO dari API dan simpan ke tb_pre_do?');">
                                            <button class="btn btn-primary mb-3 btn-block" type="submit">
                                                <i class="fas fa-cloud-download-alt"></i> Sync PO API
                                            </button>
                                        </form>
                                    </div>
                                    <div class="col-2">
                                        ...
                                        ?>
                                                <tr class="<?= $qty_masuk > 0 ? 'table-warning' : '' ?>">
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-sm btn-success btn-input-qty" title="Input Penerimaan" data-no-po="<?= htmlspecialchars($row['no_po']       ?? '') ?>" data-kd-barang="<?= htmlspecialchars($row['kd_barang'] ?? '') ?>" data-nama-barang="<?= htmlspecialchars($row['nama_barang'] ?? '') ?>" data-qty-order="<?= $qty_order ?>" data-sisa="<?= $sisa ?>" data-toggle="modal" data-target="#modalInputQty">
